...
public class Searcher {
    ...
    /*public Map<String, Integer[]> getPositionOfWordsByDocuments(final MongoDbWorker mdb, String queryWords) throws IOException {
        ...
        for (Positions p : positions) {
            if (documents.get(p.getDocument())==null){
                ...
                pp.add(p);
                documents.put(p.getDocument(), positions);
            }
        }
        return documents;
    }*/
